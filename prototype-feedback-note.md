...
```mermaid
graph TD
    T1["Tester 1 (Advanced Learner)<br/>- Muốn context khó hơn & form feedback<br/>- AI bị giới hạn, muốn hỏi code xung quanh<br/>- Test cases chưa bung hết chức năng"]
    T2["Tester 2 (Visual / Direct Learner)<br/>- UI khó nhìn chỗ AI phản hồi<br/>- Option B OK, AI giải thích dễ hiểu<br/>- Nắm rõ vấn đề & tự tìm ra đáp án"]
    T3["Tester 3 (Applied / Interactive Learner)<br/>- Thích gợi ý tư duy, muốn đem áp dụng<br/>- UI: Không biết phải cuộn xuống (scroll)<br/>- Muốn hội thoại liên tục dạng message"]
```

---

### 👤 TESTER 1 — Trải Nghiệm & Phản Hồi
...
| Khía cạnh | Chi tiết ghi nhận thực tế từ Tester 1 |
| :--- | :--- |
...
| Khía cạnh | Chi tiết ghi nhận thực tế từ Tester 2 |
| :--- | :--- |
...
| Khía cạnh | Chi tiết ghi nhận thực tế từ Tester 3 |
| :--- | :--- |
...
| :--- | :--- | :--- | :--- |
| **Đánh giá chung từ 3 Tester** | Ý tưởng được khen nhiều nhất (Tester 3 rất thích), nhưng cần cải thiện UX nhập liệu/cuộn trang và hội thoại liền mạch. | Được đánh giá thực dụng và dễ hiểu nhất (Tester 2 khen OK, hiểu ngay vấn đề và sửa được code). | Không được chọn làm phương án chính vì độ trễ, nhưng hữu ích khi muốn tạo form feedback / hỏi sâu. |
| **Friction / Pain Points chính** | • UI không tự scroll xuống khi nội dung dài (Tester 3).<br>• Bị bó hẹp ở bài tập hiện tại, chưa hỏi được code xung quanh (Tester 1). | • UI khó nhận biết vị trí AI phản hồi (Tester 2).<br>• Phụ thuộc vào việc bôi đen đúng chỗ. | • Chờ đợi 30 phút trong ca đêm là quá lâu. |
...
* **Tester 1:** Phàn nàn AI chỉ trả lời trong phạm vi hẹp của bài tập, muốn mở rộng hỏi code liên quan; đề xuất tạo Form Feedback và test case đa dạng hơn.
* **Tester 2:** Gặp khó khăn khi nhìn vị trí AI phản hồi trên UI; đánh giá Option B giải thích rất dễ hiểu và giúp hiểu ra đáp án ngay.
* **Tester 3:** Khen ý tưởng gợi mở tư duy rất hay và muốn mang áp dụng; gặp lỗi không biết phải cuộn (scroll) xuống; đề xuất luồng chat message phản hồi liên tục.
...
* Bản ghi chép đã tổng hợp trung thực toàn bộ phản hồi từ **cả 3 Tester**, chỉ rõ ưu điểm và khiếm khuyết cụ thể của từng phương án trên phương diện giao diện (UI/UX) và cơ chế hỗ trợ (Mechanism).
